...
if __name__ == '__main__':
    ...
    ransac_line, ransac_score = fit_line_ransac(data, n_sample, ransac_trial, ransac_threshold)
    print(f'RANSAC score: {ransac_score} / {data_num}')
    ...
    plt.plot(data_range, line2y(ransac_line, data_range), 'g-', label='RANSAC result')
    plt.legend()
    plt.xlim(data_range)
    plt.show()
