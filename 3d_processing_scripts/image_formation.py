...
cam_rot = [[0, 0, 0], [-15 , 15, 0], [15, -15, 0], [15, 15, 0], [-15, -15, 0]] # Unit: [deg]
...
for i, (pos, rot) in enumerate(zip(cam_pos, cam_rot)):
    # Derive 'R' and 't'
    R_world = Rotation.from_euler('xyz', rot, degrees=True).as_matrix()
